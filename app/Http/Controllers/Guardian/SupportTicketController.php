...
class SupportTicketController extends Controller
{
    ...
    /**
     * Display guardian's support tickets.
     */
    public function index(Request $request): Response
    {
        ...
        return inertia('guardian/support-tickets/Index', [
            'items' => $items,
            'filters' => [
                'status' => $status,
            ],
    ...
    {
        return inertia('guardian/support-tickets/Create', [
    ...
    public function store(StoreSupportTicketRequest $request): RedirectResponse
    {
        ...
        return redirect()
            ->route('guardian.tickets.show', $ticket)
