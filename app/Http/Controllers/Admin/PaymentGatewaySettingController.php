...
class PaymentGatewaySettingController extends Controller
{
    ...
    public function edit(): Response
    {
        ...
        $bkash = $gateways->get(PaymentGateway::GATEWAY_BKASH);
        $sslCommerz = $gateways->get(PaymentGateway::GATEWAY_SSLCOMMERZ);
        $manual = $gateways->get(PaymentGateway::GATEWAY_MANUAL);

        return inertia('admin/payment-settings/Edit', [
            'paymentSettings' => [
                'bkash' => [
                    'status' => $bkash?->status ?? PaymentGateway::STATUS_ACTIVE,
                ...
                'sslcommerz' => [
                    'status' => $sslCommerz?->status ?? PaymentGateway::STATUS_ACTIVE,
                ...
                'manual' => [
                    'status' => $manual?->status ?? PaymentGateway::STATUS_ACTIVE,
