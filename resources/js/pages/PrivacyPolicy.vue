        ...
        <main class="mx-auto max-w-7xl px-4 pb-16">
            <div class="rounded-2xl border border-slate-100 bg-white p-6 md:p-10 shadow-[0_10px_30px_rgba(2,32,71,0.06)]">
                <div class="prose prose-slate max-w-none prose-h2:mt-8 prose-h2:mb-3 prose-h3:mt-6 prose-h3:mb-2">
                    ...
                    <p>
                        If you use third-party sign-in or integrated tools, we may receive limited info from those services
                        as permitted by your settings and their policies.
                    </p>

                    <h2>3. How we use your information</h2>
                    <ul>
                        <li>Provide and improve the Services (matching, messaging, scheduling).</li>
                        <li>Verify accounts and maintain platform safety.</li>
                        <li>Respond to support requests and send service-related notifications.</li>
                    ...
                    <ul>
                        <li><strong>With other users:</strong> limited profile details needed for tutoring (e.g., tutor profile; student needs).</li>
                        <li><strong>With service providers:</strong> hosting, analytics, email delivery, customer support tools.</li>
                        <li><strong>For safety/legal reasons:</strong> to comply with law, protect users, and prevent fraud or abuse.</li>
                        <li><strong>Business transfers:</strong> if we are involved in a merger, acquisition, or asset sale.</li>
                    </ul>

                    <h2>5. Cookies and similar technologies</h2>
                    <p>
                        We use cookies to keep you signed in, remember preferences, and understand site traffic.
                    ...
                    <p>
                        ...
                        disputes, and enforce agreements. You may request deletion (see “Your choices”).
                    </p>

                    <h2>7. Security</h2>
                    <p>
                        We use reasonable safeguards to protect your information. No system is 100% secure, so please use
                        strong passwords and keep your login details confidential.
                    </p>

                    <h2>8. Your choices and rights</h2>
                    <ul>
                        <li>Access, update, or correct your account information.</li>
                        <li>Request deletion of your account (subject to legal/operational requirements).</li>
                    ...
                    <p>
                        If you access the Services from outside our operating country, your information may be processed in
                        other locations where our service providers operate.
                    </p>

                    <h2>11. Changes to this policy</h2>
                    <p>
                        We may update this policy from time to time. If changes are significant, we will provide notice as
                        required. The “Last updated” date will reflect the latest version.
                    </p>
                ...
                <div class="mt-8 flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-between">
                    <div class="text-sm text-slate-500">
                        Related: <a class="text-blue-700 font-semibold hover:text-blue-800" href="/terms">Terms of Service</a>
                    </div>
                    <a
                        href="/contact"
