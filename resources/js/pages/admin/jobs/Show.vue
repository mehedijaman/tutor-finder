...
function handleReopen(): void {
    if (confirm('Are you sure you want to re-open this job to Live status?')) {
        router.patch(
            `/admin/jobs/${props.job.id}/reopen`,
            {},
            { preserveScroll: true },
        );
    }
            ...
            <div class="flex flex-wrap items-start justify-between gap-4">
                <div class="space-y-1">
                    <div class="flex flex-wrap items-center gap-3">
                        ...
                        <Badge
                            :class="`border px-2.5 py-1 text-xs font-bold tracking-wide uppercase ${statusConfig.class}`"
                        >
                            {{ statusConfig.label }}
                        </Badge>
                    </div>
                    <p class="pl-12 text-sm text-slate-400">
                        ...
                        <span v-if="job.created_by_name">
                            · Created by {{ job.created_by_name }}</span
                        >
                    </p>
                </div>
                ...
                <div class="flex flex-wrap items-center gap-2">
                    ...
                    >
                        ...
                        <Badge
                            variant="secondary"
                            class="ml-1 bg-blue-50 text-blue-600"
                        >
                ...
                <Card class="border-blue-100 bg-blue-50/40">
                    <CardContent class="flex items-center gap-3 p-4">
                        ...
                        <div>
                            ...
                            <p class="text-xs font-semibold text-blue-500/80">
                                Views
                            </p>
                        </div>
                    </CardContent>
                ...
                <Card class="border-violet-100 bg-violet-50/40">
                    <CardContent class="flex items-center gap-3 p-4">
                        ...
                        <div>
                            ...
                            <p class="text-xs font-semibold text-violet-500/80">
                                Applications
                            </p>
                        </div>
                    </CardContent>
                            ...
                            <p class="text-xl font-black text-emerald-700">
                                {{
                                    job.salary_negotiable
                                        ? 'Negotiable'
                                        : `${job.salary_currency} ${job.salary_amount ?? '—'}`
                                }}
                            </p>
                            <p
                                class="text-xs font-semibold text-emerald-500/80"
                            >
                                Salary
                            </p>
                        </div>
                ...
                <Card class="border-amber-100 bg-amber-50/40">
                    <CardContent class="flex items-center gap-3 p-4">
                        ...
                        <div>
                            ...
                            <p class="text-xs font-semibold text-amber-500/80">
                                Days/Week
                            </p>
                        </div>
                    </CardContent>
            ...
            <div class="grid gap-6 lg:grid-cols-3">
                ...
                <div class="space-y-6 lg:col-span-2">
                            ...
                            <div>
                                ...
                                <div class="flex flex-wrap gap-1 pt-1">
                                    <Badge
                                        ...
                                        :key="subject"
                                        variant="secondary"
                                        class="bg-blue-50 text-xs text-blue-700"
                                    >
                                        {{ subject }}
                                    </Badge>
                                    <span
                    ...
                    <Card v-if="job.description">
                        <CardHeader class="pb-3">
                            <CardTitle class="text-base"
                                >Description / Requirements</CardTitle
                            >
                        </CardHeader>
                        <CardContent>
                            <p
                    ...
                    <Card
                        ...
                        class="border-rose-200 bg-rose-50/40"
                    >
                        <CardHeader class="pb-3">
                            <CardTitle
                                class="flex items-center gap-2 text-base text-rose-700"
                            >
                                <X class="h-4 w-4" />
                                Cancellation Reason
                            </CardTitle>
                ...
                <div class="space-y-6">
                    ...
                    <Card
                        ...
                        class="border-emerald-200 bg-emerald-50/30"
                    >
                        <CardHeader class="pb-3">
                            <CardTitle
                                class="flex items-center gap-2 text-base text-emerald-700"
                            >
                        ...
                        <CardContent class="space-y-3 text-sm">
                            <div>
                                <p
                                    class="text-xs font-semibold text-emerald-500/80 uppercase"
                                >
                                    Name
                                </p>
                                <Link
                            ...
                            <div v-if="job.assignment_appointed_at">
                                ...
                                <p class="font-semibold text-slate-800">
                                    {{
                                        formatDate(job.assignment_appointed_at)
                                    }}
                                </p>
                            </div>
                            <div v-if="job.assignment_confirmed_at">
                                ...
                                <p class="font-semibold text-slate-800">
                                    {{
                                        formatDate(job.assignment_confirmed_at)
                                    }}
                                </p>
                            </div>
                        </CardContent>
