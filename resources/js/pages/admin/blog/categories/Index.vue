...
function runConfirmedAction() {
    ...
    if (action === 'delete' && row) {
        router.delete(`/admin/blog/categories/${row.id}`);
    }

    if (action === 'restore' && row) {
        router.patch(`/admin/blog/categories/${row.id}/restore`);
    }

    if (action === 'force-delete' && row) {
        router.delete(`/admin/blog/categories/${row.id}/force`);
    }

    if (action === 'empty-recycle-bin') {
        router.delete('/admin/blog/categories/recycle-bin/empty');
    }
...
function handleRowAction(actionKey, row) {
    if (actionKey === 'edit') {
        router.visit(`/admin/blog/categories/${row.id}/edit`);
        return;
    }
