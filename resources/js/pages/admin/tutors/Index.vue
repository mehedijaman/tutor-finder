...
function openConfirm(action, row = null) {
    ...
    if (action === 'force-delete') {
        ...
        confirmDescription.value =
            'This action is irreversible and removes the tutor permanently.';
    ...
    if (action === 'empty-recycle-bin') {
        ...
        confirmDescription.value =
            'This will permanently delete all trashed tutors.';
    ...
    if (action === 'restore') {
        ...
        confirmDescription.value =
            'This will restore the tutor from recycle bin.';
                    ...
                    <div>
                        <h1 class="text-2xl font-semibold tracking-tight">
                            {{
                                filters.trash
                                    ? 'Tutor Recycle Bin'
                                    : `Tutors (${verificationScopeLabel})`
                            }}
                        </h1>
                        <p class="mt-1 text-sm text-muted-foreground">
                            Manage tutor records, verification, and account
                            status.
                        </p>
                    </div>
