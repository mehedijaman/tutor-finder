...
const classFilter = ref(
    props.filters.class_id ? String(props.filters.class_id) : 'all',
);
...
function openConfirm(action, row = null, payload = {}) {
    ...
    if (action === 'status') {
        ...
        confirmDescription.value = isDeactivate
            ? 'This subject will become inactive.'
            : 'This subject will become active.';
    ...
    if (action === 'restore') {
        ...
        confirmDescription.value =
            'This will restore the subject from recycle bin.';
    ...
    if (action === 'empty-recycle-bin') {
        ...
        confirmDescription.value =
            'This will permanently remove all trashed subjects.';
            ...
            <div class="flex flex-wrap items-center justify-between gap-3">
                <div class="space-y-1">
                    <h1 class="text-2xl font-semibold">
                        {{ filters.trash ? 'Subject Recycle Bin' : 'Subjects' }}
                    </h1>
                ...
                <div class="flex items-center gap-2">
                    ...
                    <Link
                        v-if="!filters.trash"
                        href="/admin/tuition/taxonomies/subjects/create"
