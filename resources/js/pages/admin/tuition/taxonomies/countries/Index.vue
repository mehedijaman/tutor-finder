...
const breadcrumbs = [{ title: 'Countries', href: '/admin/tuition/taxonomies/countries' }];
...
function openConfirm(action, row = null, payload = {}) {
    ...
    if (action === 'status') {
        ...
        confirmTitle.value = isDeactivate ? 'Deactivate Country' : 'Activate Country';
    ...
    if (action === 'restore') {
        ...
        confirmDescription.value = 'This will restore the country from recycle bin.';
    ...
    if (action === 'empty-recycle-bin') {
        ...
        confirmDescription.value = 'This will permanently remove all eligible trashed countries.';
    ...
    <AdminLayout :breadcrumbs="breadcrumbs">
        <div class="space-y-6 p-6">
            <div class="flex flex-wrap items-center justify-between gap-3">
                <div class="space-y-1">
                    <h1 class="text-2xl font-semibold">{{ filters.trash ? 'Country Recycle Bin' : 'Countries' }}</h1>
                ...
                <div class="flex items-center gap-2">
                    ...
                    <Link v-if="!filters.trash" href="/admin/tuition/taxonomies/countries/create" class="rounded-md bg-black px-4 py-2 text-sm text-white">
                        Create Country
                    </Link>
                </div>
            </div>
            ...
            <DataTable :items="items" :columns="columns" empty-text="No countries found.">
