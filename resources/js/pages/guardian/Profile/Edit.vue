        ...
        <div class="grid gap-6 p-4 xl:grid-cols-[320px_minmax(0,1fr)] sm:p-6">
            ...
            >
                ...
                >
                    ...
                    <p><span class="font-medium">Guardian Name:</span> {{ form.guardian_name || '—' }}</p>
                    <p><span class="font-medium">Occupation:</span> {{ form.occupation || '—' }}</p>
                ...
                <section
                    ...
                    class="grid gap-3 text-sm md:grid-cols-2"
                >
                    <p><span class="font-medium">Alternative Phone:</span> {{ form.phone_alt || '—' }}</p>
                    <p class="md:col-span-2"><span class="font-medium">Address:</span> {{ form.address || '—' }}</p>
                    <p class="md:col-span-2"><span class="font-medium">Notes:</span> {{ form.notes || '—' }}</p>
                </section>
            </div>
