            ...
            <div>
                ...
                >
                    ...
                    <Link
                        ...
                        href="/tutor/profile"
                        class="group flex items-center gap-4 rounded-2xl border border-blue-100 bg-blue-50/40 p-4 shadow-sm transition hover:shadow-md dark:border-blue-900/60 dark:bg-blue-950/30"
                    >
                        <div
                            class="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-blue-100 text-blue-500 dark:bg-blue-900/50 dark:text-blue-300"
                        >
                            <FileText class="h-5 w-5" />
                        </div>
                        <div class="min-w-0 flex-1">
                            <p
                                class="text-xs font-semibold text-blue-400 uppercase dark:text-blue-300"
                            >
                                Verification Fee
                            </p>
                            <p
                                class="mt-0.5 text-sm font-bold text-blue-700 dark:text-blue-200"
                            >
                                BDT 200
                            </p>
