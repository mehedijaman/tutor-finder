...
<template>
    ...
    <div class="min-h-screen bg-slate-50 p-6">
        <div class="mx-auto max-w-6xl space-y-6">
            <div class="space-y-2">
                <h1 class="text-3xl font-bold">{{ meta.title || `${siteName} Blog` }}</h1>
            ...
            <div v-if="posts.data.length === 0" class="rounded-xl border bg-white p-8 text-center text-muted-foreground">
                No blog posts found.
            </div>
            ...
            >
                <template v-for="(link, index) in posts.links" :key="`${index}-${link.label}`">
                    <span
                        v-if="!link.url"
