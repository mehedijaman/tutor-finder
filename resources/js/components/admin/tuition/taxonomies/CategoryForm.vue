...
const props = defineProps({
    ...
    cancelHref: { type: String, default: '/admin/tuition/taxonomies/categories' },
    ...
    <form class="space-y-6" @submit.prevent="submit">
        <section class="grid gap-4 rounded-xl border bg-white p-4">
            ...
            <div class="grid gap-2">
                ...
                <Input id="category-slug" :model-value="form.slug" type="text" @update:model-value="onManualSlugInput" />
                <InputError :message="form.errors.slug" />
            </div>

            <div class="grid gap-2">
                <Label for="category-description">Description</Label>
                <textarea id="category-description" v-model="form.description" rows="4" class="rounded-md border px-3 py-2 text-sm"></textarea>
            ...
            <div class="grid gap-2 sm:grid-cols-2">
                ...
                <div class="grid gap-2">
                    ...
                    <Input id="category-sort-order" v-model.number="form.sort_order" type="number" min="0" />
