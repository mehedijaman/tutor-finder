...
const props = defineProps({
    ...
    cancelHref: { type: String, default: '/admin/tuition/taxonomies/countries' },
    ...
    <form class="space-y-6" @submit.prevent="submit">
        <section class="grid gap-4 rounded-xl border bg-white p-4">
            ...
            <div class="grid gap-2">
                ...
                <Input id="country-name" v-model="form.name" type="text" required />
            ...
            <div class="grid gap-2">
                ...
                <Input id="country-slug" :model-value="form.slug" type="text" @update:model-value="onManualSlugInput" />
                <InputError :message="form.errors.slug" />
            </div>

            <div class="grid gap-2">
                <Label for="country-status">Status</Label>
                <select id="country-status" v-model="form.status" class="h-10 rounded-md border px-3 text-sm">
