...
const props = defineProps({
    ...
    cancelHref: {
        type: String,
        default: '/admin/tuition/taxonomies/countries',
    },
    ...
    <form class="space-y-6" @submit.prevent="submit">
        ...
        >
            ...
            <div class="grid gap-2">
                <Label for="country-name" class="dark:text-slate-200"
                    >Name</Label
                >
                <Input
                    id="country-name"
            ...
            <div class="grid gap-2">
                <div class="flex items-center justify-between gap-3">
                    <Label for="country-slug" class="dark:text-slate-200"
                        >Slug</Label
                    >
                    <Button
                        type="button"
            ...
            <div class="grid gap-2">
                <Label for="country-status" class="dark:text-slate-200"
                    >Status</Label
                >
                <select
                    id="country-status"
